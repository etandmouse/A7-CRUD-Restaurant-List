...
app.get('/', (req, res) => {
  res.render('index', { restaurants: restaurants_ori.results })
})

app.get('/search', (req, res) => {
  const keyword = req.query.keyword
  const restaurants = restaurants_ori.results.filter(restaurant => restaurant.name.toLowerCase().includes(keyword.toLocaleLowerCase()))

  res.render('index', { restaurants, keyword })
})

app.get('/restaurants/:restaurants_id', (req, res) => {
  const restaurants = restaurants_ori.results
  const restaurant = restaurants.find(restaurant => restaurant.id.toString() === req.params.restaurants_id)
